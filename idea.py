...
# TODO: AI based(pytorch/tensorflow/keras/numpy/scipy/matplotlib/opencv/scikit-learn on google colab) airdrone to do some IOT stuff using our own blockchain system for its cryptocurrency based on solidity smart-contract or something like iota tangle system and serverless architecture using dart api(saas, faas, baas, paas) to run airline transportation protocol app(vue-electron || flutter) built on top of CSR
