...
# TODO: solve Artificial Super Intelligence(ASI) dangerous and problems using a two way neuron wave collector which it can put/read thoughts in/from your mind like Doublegainer or Password_Cracker idea | implement the abstract of inertia or force for our ASI
