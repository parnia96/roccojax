...
# TODO: AI based(pytorch/tensorflow/keras/numpy/matplotlib/opencv on google colab) airdrone to do some IOT stuff using our own blockchain system (solidity smart-contract) and serverless architecture using dart api(saas, faas, baas, paas) to run airline transportation protocol app(vue-electron || flutter) built on top of CSR
