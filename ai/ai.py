...
# TODO: AI based(pytorch/tensorflow/keras/numpy/matplotlib/opencv on google colab) airdrone to do some IOT stuff using our own blockchain system (smart-contract) and serverless architecture(saas, faas, baas, paas) to run airline transportation protocol built on top of CSR
